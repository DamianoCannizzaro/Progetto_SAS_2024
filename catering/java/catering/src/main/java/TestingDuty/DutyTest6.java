...
public class DutyTest6 {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("\nTEST SET OVERFLOW");
            Task ofTask = CatERing.getInstance().getDutyManager().setOverflow(ds,newTask,newTask.getQty(),e.getParticipants());
            System.out.println(ofTask.toString());
            System.out.println("\nOVERFLOW SET");
